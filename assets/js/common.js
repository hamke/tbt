$(document).ready(function() {
 ...
 jQuery(document).bind('contextmenu', function(e) {
   if(!jQuery(e.target).parents().hasClass('allowContent')) {
 ...
 jQuery(document).bind('selectstart', function(e) {
     return jQuery(e.target).parents().hasClass('allowContent');
 });
 ...
 jQuery(function(){
   jQuery('#allowContent').addClass('allowContent');
 });
